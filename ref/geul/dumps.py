...
NODE_NAMES = {
    ...
    "SliceType": "조각타입", "SliceExpr": "조각", "ResultType": "결과타입", "Try": "시도", "GenericType": "제네릭타입", "TypeApply": "타입적용",
}
FIELD_NAMES = {
    ...
    "b": "거짓값", "unsigned": "부호없는", "elem": "원소", "size": "크기", "role": "역할", "raw": "원문", "lo": "시작", "hi": "끝", "type_params": "타입매개변수",
}
