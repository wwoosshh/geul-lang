...
**2단계(참조 구현) 진행 중.** 설계 결정 D-01~D-11 확정(2026-09-03), 문법 명세 판 1, 수용 테스트 108개.
`ref/`의 Python 참조 컴파일러가 108개 전부를 통과합니다 (`python build.py test`).
...
| `spec-tests/` | 명세 수용 테스트 108개 (형식은 `spec-tests/README.md`) |
